...
- [REST API 规范](https://cosmos.network/rpc/): 通过 REST 与 `infinitefuture` 全节点交互的 API 列表。
...
Cosmos Hub (名为 `infinitefuture`) 文档已经迁移到[这里](https://github.com/cosmos/infinitefuture/tree/master/docs).
