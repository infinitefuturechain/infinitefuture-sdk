...
func TestParseDecCoins(t *testing.T) {
	testCases := []struct {
		...
		{"", nil, false},
		{"4uif", nil, true},
		{"5.5atom,4uif", nil, true},
		{"0.0uif", nil, true},
		{"0.004STAKE", nil, true},
		{
			"0.004uif",
			DecCoins{NewDecCoinFromDec("uif", NewDecWithPrec(4000000000000000, Precision))},
			false,
		},
		{
			"5.04atom,0.004uif",
			DecCoins{
				...
				NewDecCoinFromDec("uif", NewDecWithPrec(4000000000000000, Precision)),
			},
			false,
		},
	}
...
func TestDecCoinsString(t *testing.T) {
	testCases := []struct {
		...
		{DecCoins{}, ""},
		{
			...
			"5.040000000000000000atom,0.004000000000000000uif",
		},
	}
...
func TestDecCoinsIntersect(t *testing.T) {
	testCases := []struct {
		...
		{"", "", ""},
		{"1.0uif", "", ""},
		{"1.0uif", "1.0uif", "1.0uif"},
		{"", "1.0uif", ""},
		{"1.0uif", "", ""},
		{"2.0stake,1.0trope", "1.9uif", "1.9uif"},
		{"2.0stake,1.0trope", "2.1uif", "2.0uif"},
