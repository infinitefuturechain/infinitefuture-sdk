...
func GenAppStateFromConfig(cdc *codec.Codec, config *cfg.Config,
	...
	return genAppStateFromConfig(cdc, config, initCfg, genDoc, genAccIterator, true)
}
func GenAppStateFromDataNodeConfig(cdc *codec.Codec, config *cfg.Config,
	initCfg InitConfig, genDoc tmtypes.GenesisDoc,
	genAccIterator types.GenesisAccountsIterator,
) (appState json.RawMessage, err error) {
	return genAppStateFromConfig(cdc, config, initCfg, genDoc, genAccIterator, false)
}
...
func genAppStateFromConfig(cdc *codec.Codec, config *cfg.Config,
	initCfg InitConfig, genDoc tmtypes.GenesisDoc,
	genAccIterator types.GenesisAccountsIterator, persistentPeer bool,
) (appState json.RawMessage, err error) {
