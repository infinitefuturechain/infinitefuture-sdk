...
Example:
$ %s query staking validator ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking unbonding-delegations-from ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking redelegations-from ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking delegation if1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking delegations if1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking delegations-to ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking unbonding-delegation if1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking unbonding-delegation if1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking redelegation if1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec ifvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking redelegation if1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec
`,
				version.ClientName,
			),
		),
