...
Example:
$ %s tx staking delegate ifvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 1000stake --from mykey
`,
				version.ClientName,
			),
		),
...
Example:
$ %s tx staking redelegate ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4 ifvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 100if --from mykey
`,
				version.ClientName,
			),
		),
...
Example:
$ %s tx staking unbond ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4 100if --from mykey
`,
				version.ClientName,
			),
		),
