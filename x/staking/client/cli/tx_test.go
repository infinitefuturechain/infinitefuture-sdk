...
func TestPrepareFlagsForTxCreateValidator(t *testing.T) {
	...
	valPubKey, _ := sdk.GetConsPubKeyBech32("ifvalconspub1zcjduepq7jsrkl9fgqk0wj3ahmfr8pgxj6vakj2wzn656s8pehh0zhv2w5as5gd80a")
	...
	params := extraParams{"5uif", "1.0", "1.0", "1.0", "1.0"}
