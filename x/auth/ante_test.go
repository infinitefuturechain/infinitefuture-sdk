...
func TestEnsureSufficientMempoolFees(t *testing.T) {
	...
	ctx := input.ctx.WithMinGasPrices(
		sdk.DecCoins{
			...
			sdk.NewDecCoinFromDec("uif", sdk.NewDecWithPrec(10000000000000, sdk.Precision)),   // 0.000001stake
		},
	)
	...
	testCases := []struct {
		...
		{NewStdFee(200000, sdk.NewCoins(sdk.NewInt64Coin("uif", 1))), false},
		{NewStdFee(200000, sdk.NewCoins(sdk.NewInt64Coin("uif", 2))), true},
