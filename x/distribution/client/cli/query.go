...
Example:
$ %s query distr validator-outstanding-rewards ifvaloper1lwjmdnks33xwnmfayc64ycprww49n33mtm92ne
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr commission ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr slashes ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4 0 100
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr rewards if1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec
$ %s query distr rewards if1jynf8n98d8af5e9arg3py3juserqy5gl6q9rec ifvaloper1jynf8n98d8af5e9arg3py3juserqy5glgzgtf4
`,
